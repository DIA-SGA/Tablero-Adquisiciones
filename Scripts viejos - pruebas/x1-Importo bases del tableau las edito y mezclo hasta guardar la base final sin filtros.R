...
#importo todos
library(pacman)
p_load(readxl,tidyverse,lubridate,stringi,stringr)
...
#procesos$`Día de Fecha creación proceso`
#procesos$`Día de Fecha creación proceso`<-as.numeric(procesos$`Día de Fecha creación proceso`)
...
#  
# class(expedientes$`Fecha de caratulación`)
# class(expedientes$`Fecha de último pase`)
# class(expedientes$`Fecha de última modificación`)
# 
# class(procesos$`Día de Fecha creación proceso`)
...
#class(sco.proc.ex$`Día de Fecha autorización`)
#class(sco.proc.ex$`Días desde autorización`)
...
# View(sco.proc.ex$`Día de Fecha creación proceso`)
# class(sco.proc.ex$`Día de Fecha creación proceso`)
# class(sco.proc.ex$`Días desde la creación del proceso`)
