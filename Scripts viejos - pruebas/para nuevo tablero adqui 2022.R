...
## para chequear los que no entraban

# no_encuentra<-c("EX-2022-06641929-APN-SGA#MS",#si
#                 "EX-2022-06635017-APN-SGA#MS",#si
#                 "EX-2022-08465465-APN-SGA#MS",#si
#                 "EX-2022-04291583-APN-SGA#MS",#si
#                 "EX-2022-09381123-APN-SGA#MS",#si
#                 "EX-2022-03668349-APN-SGA#MS",#si
#                 "EX-2021-03644348-APN-SSGA#MS",#no
#                 "EX-2021-73787935-APN-SGA#MS")#no
# 
# a<- crostab_fowmc_final %>% 
#   filter(expediente %in% no_encuentra)
# view(a)
...
## agregamos un filtro para sacar orcom di contr focsz

orcom.di.contr<-c("DI","ORCOM","CONTR")

ultimo.sin.pv.if.ifgra<-doc.acronimos %>% 
  filter(!(Acrónimo %in% orcom.di.contr))
view(ultimo.sin.pv.if.ifgra)

#B) hago una tabla con los ultimos documentos de c/expediente
##exceptuando PV, IF e IFGRA
library(dplyr)
ultimo.sin.pv.if.ifgra<-ultimo.sin.pv.if.ifgra %>%
#  rename(expediente="Expediente") %>%
  ...
  filter(Acrónimo=="CAREX" | Acrónimo=="PLIEG" | 
           ...
           Acrónimo=="DICJU") %>% 
           #Acrónimo=="DI" | #Acrónimo=="ORCOM" | Acrónimo=="CONTR") %>%  
...
base.tramitaciones.doc<-crostab_fowmc_final %>% 
